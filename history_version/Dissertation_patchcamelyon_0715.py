...
if __name__ == '__main__':
    ...
    # Plotting accuracy curves for each model
    for model_name in model_names:
        plt.figure()
        plt.plot(range(len(train_accuracies_dict[model_name])), train_accuracies_dict[model_name], label='Training Accuracy')
        plt.plot(range(len(val_accuracies_dict[model_name])), val_accuracies_dict[model_name], label='Validation Accuracy')
        plt.xlabel('Epoch')
        plt.ylabel('Accuracy')
    ...
    for model_name in model_names:
        plt.figure()
        plt.plot(range(len(train_losses_dict[model_name])), train_losses_dict[model_name], label='Training Loss')
        plt.plot(range(len(val_losses_dict[model_name])), val_losses_dict[model_name], label='Validation Loss')
        plt.xlabel('Epoch')
        plt.ylabel('Loss')
